...
module.exports = class Conversation {
    ...
    async activeTaskFinished() {
        ...
        if(!isTask2){
            this.coins += 25;
            await this.bot.sendVideo(this.chatId, "Thanks helping me out! I've added 25 coins to your balance, you now have " + this.coins + " coins!", "coins.gif");
        } else{
            await this.bot.sendVideo(this.chatId, "We have substracted 25 coins from your treasure chest leaving you with " + this.coins + " coins!", "coins2.gif");
        }
    }
