...
module.exports = class Conversation {
    ...
    constructor(name, chatId) {
        ...
        this.name = name;
        this.coins = 0;
        this.activeTask = new Task3(this); //when conversation is first created, start with task 1 (registration chat)
    ...
    async activeTaskFinished(multiplier) {
        ...
        if (!isTask2) {
            ...
            await this.bot.sendMessage(this.chatId, "I have substracted 25 coins from your treasure chest leaving you with " + this.coins + " coins.");
        }
