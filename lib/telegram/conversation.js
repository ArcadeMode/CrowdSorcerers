...
module.exports = class Conversation {
    ...
    constructor(name, chatId){
        ...
        this.name = name;
        this.coins = 0;
        //TODO: start with Task 1..
        this.activeTask = new Task4(this, SpotsIO.getSpotsFromFile()[0]); //when conversation is first created, start with task 1 (registration chat)
