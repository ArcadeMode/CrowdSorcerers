...
module.exports = class Conversation {
    ...
    async activeTaskFinished(multiplier) {
        ...
        if(this.activeTask instanceof Task2) {
            ...
            this.activeTask = new Task4(this, SpotsIO.getSpotsFromFile()[0]);//this.activeTask.bestLocations[0]);
            ...
            this.activeTask = new Task4(this, SpotsIO.getSpotsFromFile()[0]);//this.activeTask.nearbySpots[this.activeTask.spot]);
        } else {
            this.activeTask = undefined;
        }
