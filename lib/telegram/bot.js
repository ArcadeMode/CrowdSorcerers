...
module.exports = class TelegramBot {
    ...
    processMessage(message) {
        ...
        let randomConvo = this.conversations.get(setsUtil.getRandomKey(this.conversations));
        if(message.text.indexOf('/task3') === 0) {
            console.log("task3 bitch");
            randomConvo.overrideTask(3);
            return;
        } else if(message.text.indexOf('/task4') === 0) {
            console.log("task4 bitch");
