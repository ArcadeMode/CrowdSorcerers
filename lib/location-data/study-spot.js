...
module.exports = class StudySpot {
    ...
    setProperties(latitude,longitude, description, floor, buildingnr, updates, capacity) {
        ...
        this.updates = updates.map(update => {
            //TODO CONSIDER REMOVING? CURRENTLY AUTOMATICALLY SET EXISTING UPDATES TO CURRENT TIME (VALID FOR ANOTHER 30 MINUTES)
    ...
    toString(){
        return "\""+this.description + "\" at building " + this.buildingnr + " on floor " + this.floor;
    }
};
